...
class order_stock(QAxWidget, QThread):
    ...
    def CSPAT00600_request(self, scode , quanti, gubun):
        print('주문요청')
        ...
        self.ActiveX.SetFieldData("CSPAT00600InBlock1", "MgntrnCode", 0, "000")
        self.ActiveX.SetFieldData("CSPAT00600InBlock1", "LoanDt", 0, "")
